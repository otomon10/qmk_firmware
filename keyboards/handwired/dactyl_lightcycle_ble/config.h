...
#define MANUFACTURER    otomon10
#define PRODUCT         Dactyl LightCycle BLE
 ...
 *
*/
#define MATRIX_ROW_PINS {7, 8, 9, 10}
#define MATRIX_COL_PINS {20, 19, 18, 17, 16, 15, 14, 13}
