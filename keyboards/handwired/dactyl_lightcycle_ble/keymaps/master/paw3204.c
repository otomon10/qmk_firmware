...
typedef int (*spi_paw3204_t)(uint8_t *p_tx_buffer, size_t tx_length,
                             uint8_t *p_rx_buffer, size_t rx_length,
                             uint8_t cs_pin);

#ifndef PAW3204_SCLK
#    define PAW3204_SCLK 11
#endif

#ifndef PAW3204_DATA
#    define PAW3204_DATA 12
#endif

int spi_soft_half_duplex(uint8_t *p_tx_buffer, size_t tx_length,
                         uint8_t *p_rx_buffer, size_t rx_length,
                         uint8_t cs_pin) {
